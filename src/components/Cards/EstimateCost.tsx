...
//       <div className="w-full max-w-4xl bg-white p-6 rounded-lg shadow-lg flex items-center justify-center">
//         <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
//           <h2 className="text-gray-700 text-lg font-semibold mb-2">Beautifulhomes</h2>
...
//               <div className="w-11 h-6 bg-green-500 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
//             </label>
//             <span className="text-green-600 text-sm">Update me on WhatsApp</span>
//           </div>
...
//               <span className="text-gray-600 text-sm">Construction work going on at my house</span>
//             </label>
//             <label className="flex items-center space-x-2">
//               <input type="checkbox" className="form-checkbox text-gray-700" />
//               <span className="text-gray-600 text-sm">Local painter hired</span>
//             </label>
//           </div>
...
//           {/* Button */}
//           <button className="w-full bg-black text-white py-3 rounded-lg font-semibold text-lg hover:bg-gray-800 transition-colors flex items-center justify-center">
  ...
  <div className="space-y-4">
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-green-600 text-base">Update me on WhatsApp</span>
      </div>
      ...
      <div className="flex gap-4 flex-wrap">
        ...
        <label className="flex items-center gap-2">
          <input type="checkbox" className="form-checkbox text-gray-700" />
          <span className="text-gray-600 text-base">Local painter hired</span>
        </label>
      </div>
    </div>
